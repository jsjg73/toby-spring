...
public class PointcutExpressionTest {
	...
	public void pointcut() throws Exception{
		...
		targetClassPointcutMatches("execution(* method())", false,false,false,false,true,true);
		...
		targetClassPointcutMatches("execution(* *us(..))", false,false,true,true,false,false);
